                ...
                if ( chip.name == settings.chip ) {
                    chip.cnns.forEach(function(cnn) {
                        if ( cnn.name == settings.cnn ) {
                            ...
                            else if ( settings.source == "WebCam" ) {
                                params.file = settings.source + ":" + 0; //Todo
                            }
                            if ( action.hasMediaOutput ) {
                                if ( settings.inputType == "Image") {
                                    params.outputFile = settings.outputFilePath+"output.png";
                                }
                                else if ( settings.inputType == "Video") {
                                    params.outputFile = settings.outputFilePath+"output.avi";
                                    console.log("========"+params.outputFile)
                                    if ( action.hasMediaOutput ) {
                                        setTimeout( function() {
                                            cb(null,null,null,params.outputFile)
                                        }, 4000 )
                                    }
                                }
                            }
